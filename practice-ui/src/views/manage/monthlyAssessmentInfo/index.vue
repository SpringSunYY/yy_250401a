  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="monthlyAssessmentInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="考核编号" align="center" v-if="columns[0].visible" prop="id" />
        <el-table-column label="公司编号" :show-overflow-tooltip="true" align="center" v-if="columns[1].visible" prop="companyId" />
        <el-table-column label="考核年份" :show-overflow-tooltip="true" align="center" v-if="columns[2].visible" prop="assessYear" />
        <el-table-column label="考核月份" :show-overflow-tooltip="true" align="center" v-if="columns[3].visible" prop="assessMonth" />
        <el-table-column label="考核得分" :show-overflow-tooltip="true" align="center" v-if="columns[4].visible" prop="score" />
        <el-table-column label="评语" :show-overflow-tooltip="true" align="center" v-if="columns[5].visible" prop="comments" />
        <el-table-column label="创建人" :show-overflow-tooltip="true" align="center" v-if="columns[6].visible" prop="createBy" />
        <el-table-column label="用户" :show-overflow-tooltip="true" align="center" v-if="columns[7].visible" prop="userId" />
        <el-table-column label="班级" :show-overflow-tooltip="true" align="center" v-if="columns[8].visible" prop="deptId" />
...
<script>
import { listMonthlyAssessmentInfo, getMonthlyAssessmentInfo, delMonthlyAssessmentInfo, addMonthlyAssessmentInfo, updateMonthlyAssessmentInfo } from "@/api/manage/monthlyAssessmentInfo";
