  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="postInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="岗位编号" align="center" v-if="columns[0].visible" prop="postId" />
        ...
        <el-table-column label="岗位名称" :show-overflow-tooltip="true" align="center" v-if="columns[2].visible" prop="postName" />
        ...
        <el-table-column label="岗位描述" :show-overflow-tooltip="true" align="center" v-if="columns[4].visible" prop="postDesc" />
        <el-table-column label="岗位描述" :show-overflow-tooltip="true" align="center" v-if="columns[5].visible" prop="postRequired" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="岗位描述" prop="postRequired">
