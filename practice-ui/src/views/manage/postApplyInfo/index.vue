  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="postApplyInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="申请编号" align="center" v-if="columns[0].visible" prop="applyId" />
        ...
        <el-table-column label="简历编号" :show-overflow-tooltip="true" align="center" v-if="columns[2].visible" prop="resumeId" />
        <el-table-column label="岗位编号" :show-overflow-tooltip="true" align="center" v-if="columns[3].visible" prop="postId" />
        ...
        <el-table-column label="班级" :show-overflow-tooltip="true" align="center" v-if="columns[6].visible" prop="deptId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="简历编号" prop="resumeId">
          <el-input v-model="form.resumeId" placeholder="请输入简历编号" />
        </el-form-item>
        <el-form-item label="岗位编号" prop="postId">
          <el-input v-model="form.postId" placeholder="请输入岗位编号" />
        </el-form-item>
        <el-form-item label="状态" prop="applyStatus">
...
<script>
import { listPostApplyInfo, getPostApplyInfo, delPostApplyInfo, addPostApplyInfo, updatePostApplyInfo } from "@/api/manage/postApplyInfo";
