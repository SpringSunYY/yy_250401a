  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="workReportInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="报告编号" align="center" v-if="columns[0].visible" prop="id" />
        ...
        <el-table-column label="工作内容描述" :show-overflow-tooltip="true" align="center" v-if="columns[3].visible" prop="content" />
        <el-table-column label="未来计划" :show-overflow-tooltip="true" align="center" v-if="columns[4].visible" prop="plan" />
        <el-table-column label="遇到问题" :show-overflow-tooltip="true" align="center" v-if="columns[5].visible" prop="problems" />
        ...
        <el-table-column label="班级" :show-overflow-tooltip="true" align="center" v-if="columns[9].visible" prop="deptId" />
...
<script>
import { listWorkReportInfo, getWorkReportInfo, delWorkReportInfo, addWorkReportInfo, updateWorkReportInfo } from "@/api/manage/workReportInfo";
    ...
    return {
      ...
      columns: [
        { key: 0, label: '报告编号', visible: true },
          ...
          { key: 3, label: '工作内容描述', visible: true },
          { key: 4, label: '未来计划', visible: true },
          { key: 5, label: '遇到问题', visible: true },
